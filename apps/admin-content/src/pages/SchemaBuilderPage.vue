...
<template>
  <div class="schema-builder">
    <div class="header">
      ...
      <el-button type="primary" :icon="Plus" @click="handleAddSchema">
        Create Schema
      </el-button>
    </div>
    ...
    <el-table :data="schemas" v-loading="loading" style="width: 100%">
      ...
      <el-table-column label="Actions" width="200">
        <template #default="scope">
          <el-button :icon="Edit" size="small" @click="handleEditSchema(scope.row)">
            Edit
          </el-button>
          <el-button :icon="Delete" size="small" type="danger" @click="deleteSchema(scope.row.id)">
            Delete
          </el-button>
        </template>
      </el-table-column>
      ...
      <el-form :model="form" label-width="100px">
        ...
        <div class="fields-section">
          <div class="fields-header">
            <h3>Fields</h3>
            <el-button type="success" size="small" :icon="Plus" @click="addField">
              Add Field
            </el-button>
          </div>
